...
class WebTools
{
    ...
    /**
     * Set the command output when method=exec.
     * @param $commandOutput
     * @return void
     */
    ...
    private function pingFsockopen()
    {
        ...
        // fsockopen prints a bunch of errors if a host is unreachable. Hide those irrelevant errors and deal with the results instead.
